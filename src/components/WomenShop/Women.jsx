  ...
  // })
    return (
        ...
        <div className="Sport">
           ...
           <div className="MainerBek">
<h1>SUPERSTAR XLG</h1>
<p>Stay true to your style with a refreshed classic</p>
           </div>
...
<div className="Almiron">
  <div className="TexterE">
  <h1>SUPERSTAR XLG STARBOOK</h1>
  <p>A community-powered style project celebrating the Superstar XLG in contemporary streetwear culture</p>
